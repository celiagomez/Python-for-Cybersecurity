...
#This code defines a function SSHLogin that attempts to establish an SSH connection to a remote host using the provided credentials. If the connection is successful, it prints a success message; otherwise, it prints a failure message.
...
#This code defines a function TelnetLogin that attempts to establish a Telnet connection to a remote host using the provided credentials. If the connection is successful, it prints a success message; otherwise, it prints a failure message.
